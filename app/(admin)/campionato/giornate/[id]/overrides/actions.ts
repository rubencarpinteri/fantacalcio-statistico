...
export async function createOverrideAction(
  ...
  revalidatePath(`/campionato/giornate/${matchday_id}/overrides`)
  revalidatePath(`/campionato/giornate/${matchday_id}/calculate`)
...
export async function removeOverrideAction(
  ...
  revalidatePath(`/campionato/giornate/${matchdayId}/overrides`)
  revalidatePath(`/campionato/giornate/${matchdayId}/calculate`)
