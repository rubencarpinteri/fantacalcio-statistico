...
export async function upsertStatsAction(
  ...
  revalidatePath(`/campionato/giornate/${matchday_id}/stats`)
  revalidatePath(`/campionato/giornate/${matchday_id}`)
...
export async function toggleProvisionalAction(
  ...
  revalidatePath(`/campionato/giornate/${matchdayId}/stats`)
  return { error: null }
}
...
const CSV_COLUMN_ALIASES: Record<string, keyof StatRow | 'full_name' | 'club'> = {
  ...
  rating: 'rating', voto: 'rating', sportmonks: 'rating',
