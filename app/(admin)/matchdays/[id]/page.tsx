  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between">
        <div>
          <a href="/matchdays" className="text-[12.5px] text-ink-4 transition-colors hover:text-indigo-300">
            ← Giornate
          </a>
              ...
              <div className="space-y-3">
                ...
                {['closed', 'archived'].includes(matchday.status) && (
                  <div className="flex flex-col gap-1">
                    ...
                    <a href={`/matchdays/${id}/results`} className="text-sm text-ink-4 hover:text-indigo-400">Tutti i risultati →</a>
                  </div>
                )}
              </div>
            </CardContent>
          ...
          <CardHeader
            ...
            action={
              <div className="flex items-center gap-3">
                ...
                <a href={`/matchdays/${id}/calculate`} className="text-xs text-ink-4 hover:text-indigo-300">
                  Calcolo →
                </a>
              </div>
            }
