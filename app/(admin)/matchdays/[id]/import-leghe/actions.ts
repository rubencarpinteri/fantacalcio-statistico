...
async function autoFetchAndCreateRun(
  ...
  const statsRows = matched.map(({ stat, player }) => ({
    ...
    total_tackles: stat.tackles_won,
    interceptions: stat.interceptions,
    clearances: stat.clearances,
    blocks: stat.blocks,
    aerial_duels_won: stat.aerial_won,
    aerial_won: stat.aerial_won,
    dribbled_past: stat.dribbled_past,
    error_leading_to_goal: stat.error_leading_to_goal,
    key_passes: stat.key_passes,
    expected_assists: stat.xa,
    successful_dribbles: stat.successful_dribbles,
    dribble_success_rate: null,
    completed_passes: stat.accurate_passes,
    pass_accuracy: null,
    final_third_passes: stat.final_third_passes,
    progressive_passes: null,
    xg: stat.xg,
    xa: stat.xa,
    shots: stat.shots,
    shots_on_target: stat.shots_on_target,
    blocked_scoring_attempt: stat.blocked_scoring_attempt,
    big_chance_created: stat.big_chance_created,
    big_chance_missed: stat.big_chance_missed,
    accurate_passes: stat.accurate_passes,
    accurate_long_balls: stat.accurate_long_balls,
    total_crosses: stat.total_crosses,
    touches: stat.touches,
    dispossessed: stat.dispossessed,
    ball_recoveries: stat.ball_recoveries,
    duel_won: stat.duel_won,
    duel_lost: stat.duel_lost,
